...
NEW_CENTER_CITIES_CENTROIDS=ee.Dictionary({
  ...
  'Boras': ee.Geometry.Point([12.94152909517508,57.72269986139307]), 
  ...
  'Gandhinagar': ee.Geometry.Point([72.64826863174639,23.244537325446927]),
  'Satkhira': ee.Geometry.Point([89.07372533970154,22.711751440238693]),
  ...
  'Billings': ee.Geometry.Point([-108.50067893095184,45.786345365857734]),
  ...
  'Yuma': ee.Geometry.Point([-114.62853956542635,32.704680060058834]), 
  'South Lyon-Howell-Brighton': ee.Geometry.Point([-83.78094233241319,42.52974952964617]),
  'Aberdeen-Havre de Grace-Bel Air': ee.Geometry.Point([-76.16709854779967,39.50839272273559]), 
...
# New additions 8/9/2023 - Cities that work in some later year(s), but for 1980 receive Error: Image.clip: The geometry for image clipping must not be empty. (Error code: 3)
  ...
  'Aizawl': ee.Geometry.Point([92.7177528225866,23.733974312513187]), 
  ...
  'Hurghada': ee.Geometry.Point([33.82443314923356,27.248258224734627]), # possible GHSL model problem 
  ...
  'Kolar Gold Fields': ee.Geometry.Point([78.27256887178822,12.959291264081994]), # original centroid in "Kolar" instead of "Kolar Gold Fields"
...
NEW_CENTER_CITIES_CENTROIDS_IDS=ee.Dictionary({
  ...
  1658: ee.Geometry.Point([121.20555815114098,31.604542976371015]),
  1489: ee.Geometry.Point([120.98992648714702,31.71978069030085]),
  1132: ee.Geometry.Point([89.94855423818369,24.926103094510093]),
  3069: ee.Geometry.Point([78.77428597780887,10.073719259964795]),
  3654: ee.Geometry.Point([125.21120891444515,39.692717483222644]),
  1958: ee.Geometry.Point([105.75970185018825,29.565398566982942]),
  # 2832: ee.Geometry.Point(), # multiple cities with same name # centroid looks good, possible GHSL model problem 
  2375: ee.Geometry.Point([109.45744163839055,31.02165498424339]),
  2458: ee.Geometry.Point([115.17444691365134,23.64059167611271]),
  3279: ee.Geometry.Point([80.4866668467864,26.546323806819593]),
  2065: ee.Geometry.Point([119.12542863584517,34.8337074499451]),
  2414: ee.Geometry.Point([108.80201590486517,37.59626431072397]),
  2854: ee.Geometry.Point([77.27314606736755,15.624470029873141]),
  2326: ee.Geometry.Point([111.23004967551621,39.865278037689336]),
  3033: ee.Geometry.Point([77.82829157874853,12.732869649636683]),
  1525: ee.Geometry.Point([117.19497699443556,32.95965897629651]),
  1526: ee.Geometry.Point([106.02904023821081,27.032147088073874]),
  1548: ee.Geometry.Point([116.36683684379712,33.93564859928222]),
  4646: ee.Geometry.Point([100.88579760887355,12.9353767202565]), 
  2235: ee.Geometry.Point([120.91217476768942,30.844620550890788]), 
  3744: ee.Geometry.Point([33.76808587203004,-13.982171942323067]), 
  1628: ee.Geometry.Point([109.99582280020206,39.81559591604334]), 
  1142: ee.Geometry.Point([91.09706670097057,22.868936634057867]), 
  4925: ee.Geometry.Point([-115.56038988156142,32.79286256561882]),
  2344: ee.Geometry.Point([121.3749378997016,37.547713687836136]), 
  2186: ee.Geometry.Point([121.43429069821823,28.6817640387459]), 
  2332: ee.Geometry.Point([120.13168862294013,33.394676035552955]), 
  1617: ee.Geometry.Point([118.50351106829504,37.45873900992769]), 
  1833: ee.Geometry.Point([119.64028627257649,29.10402766701154]), 
  2369: ee.Geometry.Point([119.8132470013679,31.369521760803412]), 
  2350: ee.Geometry.Point([128.8894324851581,47.72415021954703]), 
  1846: ee.Geometry.Point([115.97424022409739,29.719992498318497]), 
  2448: ee.Geometry.Point([122.23816470490492,29.969200590789747]), 
  1925: ee.Geometry.Point([121.12606568700242,28.846819764887197]), 
  1470: ee.Geometry.Point([106.76211868650547,31.85258212620844]), 
  2212: ee.Geometry.Point([108.97886725893385,34.912815304164866]), 
  2105: ee.Geometry.Point([109.49646174716976,18.25739391478926]), 
  2376: ee.Geometry.Point([116.43948966757146,33.92335674422714]), 
  2041: ee.Geometry.Point([103.94017442609707,30.986599248800818]), 
  2461: ee.Geometry.Point([104.64683534160156,30.121222096840697]), 
  1992: ee.Geometry.Point([103.83420951654202,30.04494883675573]), 
  1693: ee.Geometry.Point([106.63827892993167,30.47635384542008]), 
  1898: ee.Geometry.Point([111.66595064594073,27.690509688793448]), 
  1729: ee.Geometry.Point([108.05245421323114,24.697534623371652]), 
  1646: ee.Geometry.Point([120.84733390061464,31.053257991703546]), 
  1895: ee.Geometry.Point([111.74112129949387,27.247701079233547]), 
  2437: ee.Geometry.Point([120.25586969185073,30.878699595892858]), 
  1490: ee.Geometry.Point([109.97714909503249,22.274700447742724]), 
  1795: ee.Geometry.Point([119.27021601384536,29.474593192687]), 
  2145: ee.Geometry.Point([108.71986426692655,30.92689670667686]), 
  2442: ee.Geometry.Point([105.18412461495434,37.51517184194114]), 
  2443: ee.Geometry.Point([105.18412461495434,37.51517184194114]), # duplicate centroid
  1473: ee.Geometry.Point([104.47941316358167,31.591390967496743]), 
  1474: ee.Geometry.Point([104.47941316358167,31.591390967496743]), # duplicate centroid
  1661: ee.Geometry.Point([104.99012100670018,29.18284568824579]), 
  2253: ee.Geometry.Point([119.02412258879161,42.930535608578076]), 
  1844: ee.Geometry.Point([118.3292610157374,30.92231962776307]), 
  2354: ee.Geometry.Point([111.87097812372912,34.742166564465705]), 
  1919: ee.Geometry.Point([121.11399566493397,28.846500900385657]), 
  1656: ee.Geometry.Point([105.3770566127296,29.150981918335756]), 
  1677: ee.Geometry.Point([118.84571330212547,33.29772124432854]), 
  1637: ee.Geometry.Point([112.02250678087194,37.4365231886347]), # multiple cities with same name
  1568: ee.Geometry.Point([118.87450763850858,31.32604548469979]), 
  2398: ee.Geometry.Point([116.68784727831236,28.695160226266914]), 
  2156: ee.Geometry.Point([111.93772315602936,25.591981047187556]), 
  1462: ee.Geometry.Point([118.74891639378922,25.425925567214794]), 
  2229: ee.Geometry.Point([118.56811554164432,31.145818740882557]), 
  2126: ee.Geometry.Point([116.68873047083383,39.06018347672968]), 
  # 1491: ee.Geometry.Point(), # centroid looks good, possible GHSL model problem 
  1960: ee.Geometry.Point([118.24332638719892,25.492609943479106]), 
  2401: ee.Geometry.Point([113.90423752186902,29.97623692044738]), 
  1650: ee.Geometry.Point([120.01431421641483,29.205024638918918]), 
  2163: ee.Geometry.Point([103.03614350443604,25.339298793507883]), 
  1718: ee.Geometry.Point([120.7984389455408,31.752944431536996]), 
  # 1751: ee.Geometry.Point(), # centroid looks good, possible GHSL model problem 
  1993: ee.Geometry.Point([115.90259636898394,31.849146954929974]), 
  1988: ee.Geometry.Point([107.57980897099333,23.31804885957945]), 
  1728: ee.Geometry.Point([120.284544023292,28.142873828872464]), 
  1567: ee.Geometry.Point([111.37232717400593,29.587881805303734]), 
  2190: ee.Geometry.Point([113.54145560138647,22.382792683944597]), 
  2287: ee.Geometry.Point([117.11848878780731,34.80945239401825]), 
  1806: ee.Geometry.Point([116.33662804394508,35.396950373034265]), 
  1776: ee.Geometry.Point([113.96852040855958,31.251871168585666]), 
  1822: ee.Geometry.Point([118.39896795971129,30.689924658920734]), 
  1680: ee.Geometry.Point([110.57362116354828,27.06377183540011]), 
  1969: ee.Geometry.Point([103.26657774875106,24.760899989674606]), 
  # 1987: ee.Geometry.Point(), # possible GHSL model problem? new city?
  1644: ee.Geometry.Point([118.8519403174272,25.24922269137163]), 
  2011: ee.Geometry.Point([108.11215495944043,30.00019803547434]),
  3117: ee.Geometry.Point([79.44679501073952,18.875405683552366]), 
  3766: ee.Geometry.Point([118.08998272250614,5.864097785379566]),
})

NON_UNIVERSE_CITIES = [
    ee.Feature(ee.Geometry.Point([58.40262571690767,23.59262875967398])).set(
        'City Name','Muscat',
        'Country Name','Oman',
        'City ID Number', 7000,
        'Pop_2010', 20000,
        'Source','Citypopulation.de',
        'Reg_Name','Western Asia and North Africa (WANA)'
        ), 
    ee.Feature(ee.Geometry.Point([35.31926146784602,-15.386653512539498])).set(
        'City Name','Zomba',
        'Country Name','Malawi',
        'City ID Number', 7001,
        'Pop_2010', 91000,
        'Source','Citypopulation.de',
        'Reg_Name','Sub-Saharan Africa (SSA)'
        ), 
    ee.Feature(ee.Geometry.Point([-88.19402318079558,17.50296536347089])).set(
        'City Name','Belize City',
        'Country Name','Belize',
        'City ID Number', 7002,
        'Pop_2010', 57169,
        'Source','Citypopulation.de',
        'Reg_Name','Latin America and the Caribbean (LAC)'
        ), 
    ee.Feature(ee.Geometry.Point([-88.36657504436835,16.516072469052233])).set(
        'City Name','Placencia',
        'Country Name','Belize',
        'City ID Number', 7003,
        'Pop_2010', 750,
    ...
    ee.Feature(ee.Geometry.Point([-87.96409195887496,17.918308175657028])).set(
        'City Name','San Pedro',
        'Country Name','Belize',
        'City ID Number', 7004,
        'Pop_2010', 11765,
    ...
    ee.Feature(ee.Geometry.Point([-72.0662726593099,-45.570501991695295])).set(
        'City Name','Coyhaique',
        'Country Name','Chile',
        'City ID Number', 7005,
        'Pop_2010', 57864,
    ...
    ee.Feature(ee.Geometry.Point([-91.47091724633397,15.320787249142679])).set(
        'City Name','Huehuetenango',
